...
import dependency.DependencyFactory;
...
public class DependencyPackageImpl extends EPackageImpl implements DependencyPackage {
	 ...
	 * @see dependency.DependencyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getGraph_Instances() {
	 ...
	 * @generated
	 */
	public EAttribute getVertex_UUID() {
	 ...
	 * @generated
	 */
	public EReference getVertex_DependsOn() {
	...
	public void createPackageContents() {
		...
		createEReference(graphEClass, GRAPH__INSTANCES);

		vertexEClass = createEClass(VERTEX);
		createEAttribute(vertexEClass, VERTEX__UUID);
		createEReference(vertexEClass, VERTEX__DEPENDS_ON);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getGraph_Instances(), this.getVertex(), null, "instances", null, 0, -1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(vertexEClass, Vertex.class, "Vertex", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVertex_UUID(), ecorePackage.getEString(), "UUID", null, 1, 1, Vertex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVertex_DependsOn(), this.getVertex(), null, "dependsOn", null, 0, -1, Vertex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
