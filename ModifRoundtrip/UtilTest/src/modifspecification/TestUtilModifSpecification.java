...
public class TestUtilModifSpecification {
	...
	public static void main(String[] args) {
		...
		Modifications modifSpecificationLoad = IOModifSpecification.loadModifSpecification("C:/ModifRoundtrip-project/ModifRoundtrip/UtilTest/modif/Test1/CopyMPL.modif");
		
		UtilModifSpecification.minimizeToUpdate();
		Modifications modifSpecificationMinUpdate2 = UtilModifSpecification.getModifSpecification();
		IOModifSpecification.saveModifSpecification(modifSpecificationMinUpdate2, "C:/ModifRoundtrip-project/ModifRoundtrip/UtilTest/modif/Test3/CopyMPLMinUpdate2.modif");

		UtilModifSpecification.minimizeStrong();
		Modifications modifSpecificationMinStrong2 = UtilModifSpecification.getModifSpecification();
		IOModifSpecification.saveModifSpecification(modifSpecificationMinStrong2, "C:/ModifRoundtrip-project/ModifRoundtrip/UtilTest/modif/Test3/CopyMPLMinStrong2.modif");
